...
const benefits = [
  ...
  "Unlimited paraphrasing sessions",
  "Advanced grammar insights",
  "Writing DNA personalization",
];
            ...
            <div className="flex gap-4">
              {features.map((feature, i) => (
                <motion.div
                  ...
                  className="w-14 h-14 rounded-xl bg-card/80 backdrop-blur flex items-center justify-center border border-border/50 hover:border-primary/50 transition-colors"
                >
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {error && (
              <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="p-4 rounded-xl bg-destructive/10 border border-destructive/20 text-destructive text-sm">
                {error}
              </motion.div>
            )}
            {success && (
              <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="p-4 rounded-xl bg-success/10 border border-success/20 text-success text-sm">
                {success}
              </motion.div>
            )}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                rightElement={
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="p-1 hover:bg-accent rounded">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <Button type="button" variant="outline" className="w-full" onClick={() => handleOAuth("google")} disabled={oauthLoading !== null} isLoading={oauthLoading === "google"}>
                {!oauthLoading && (
              ...
              <Button type="button" variant="outline" className="w-full" onClick={() => handleOAuth("github")} disabled={oauthLoading !== null} isLoading={oauthLoading === "github"}>
                {!oauthLoading && (
