    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary/20 via-background to-purple-500/10">
        ...
        <motion.div
          ...
          className="absolute top-1/4 right-12 w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500/30 to-pink-500/30 backdrop-blur border border-purple-500/20"
        />
        <motion.div
          animate={{
            y: [0, 20, 0],
          ...
          className="absolute bottom-1/4 left-12 w-16 h-16 rounded-full bg-gradient-to-br from-primary/30 to-purple-500/30 backdrop-blur border border-primary/20"
        />
      </div>
